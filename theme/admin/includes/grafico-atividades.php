...
WHERE month(data_registro_relatorio) = 1 id_aluno=:id", $parametros);
...
WHERE month(data_registro_relatorio) = 2 id_aluno=:id", $parametros);
...
WHERE month(data_registro_relatorio) = 9 id_aluno=:id", $parametros);
...
WHERE month(data_registro_relatorio) = 10 id_aluno=:id", $parametros);
...
WHERE month(data_registro_relatorio) = 11 id_aluno=:id", $parametros);
...
WHERE month(data_registro_relatorio) = 12 id_aluno=:id", $parametros);
